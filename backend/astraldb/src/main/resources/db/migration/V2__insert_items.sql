...
INSERT INTO tmp_banners (gacha_id, banner_name, image_url, item_id)
SELECT
  gacha_id,
  banner_name,
  image_url,
...
INSERT INTO banner (gacha_id, banner_name, image_url, item_id)
SELECT gacha_id, banner_name, image_url, item_id FROM tmp_banners;
